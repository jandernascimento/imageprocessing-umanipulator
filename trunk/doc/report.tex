...
\section{Color space}    
	...
	\subsection{Gray scale conversion}
		...
		In order to convert an image to gray scale from an RGB image to gray scale, we need to consider how far a pixel is from black. To achieve this goal, one can substitue all the colors of a pixel with the average of the three colors. Using this method, a pure black pixel would remain black, and a white pixel would still remain white. Other pixels, however, would be have a gray view between black and white.
...
\section{Cropping}
	...
	\begin{figure}[H]
	  \centering
	  \subfloat[Non cropped image]{\label{fig:nonnormalized}\includegraphics[width=0.3\textwidth]{images/crop_1}}                
	  \subfloat[Cropped image]{\label{fig:normalized}\includegraphics[width=0.3\textwidth]{images/crop_2}}
...
\section{Fusion}
	...
	The fusion operation is done by merging two images. The merging is done according do the Equation \ref{eq:fusion}. 
