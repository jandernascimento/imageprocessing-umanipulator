...
\section{Filters}
	...
	\subsection{Fundamental}
		...
		\subsubsection{Convolution}
			...
			The following formulas describe the descrete convolution formula in 1D and 2D space:
		...
		\subsubsection{Mean}
			...
			a 3*3 mean filter is a matix in which all cells filled up with 1/9 .	
		...
		\subsubsection{Gradient}
			...
			Technically, an edge is a part of image where a sharp change is occured in the brightness of the pixels.
		...
		\subsubsection{Laplacian}
			The Laplacian filter is computed based on the second derivation of the input.The following matrix is an approximation of a 3*3 Laplacian filter:
	\begin{center}
  \begin{tabular}{ | l | c | r | }
    \hline
    -1 & -1 & -1 \\ \hline
...
\end{center}
			...
			assosiative. the following is the LoG formula in 2D space:
